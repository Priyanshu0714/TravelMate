...
document.getElementById("search-button").addEventListener("click", async () => {
  ...
  // to delete the matching travel
  document.getElementById("create-matching-travellers").innerHTML = `<button id="enable-pop-up" class="h-auto w-[400px] border border-gray-400 bg-gray-200 flex justify-center items-center gap-5 flex-col rounded-lg p-5">
          Not intrested?<br>
          Click to Add your own details
        </button>`;
